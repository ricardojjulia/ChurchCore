...
const options = [
  {
    ...
    description:
      "Supabase is approved as the backend and data platform for ChurchForge, using Postgres, Auth, Realtime, and Storage.",
    icon: Zap,
  },
  {
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            ...
            <p className="max-w-3xl text-lg leading-8 text-muted-foreground">
              ChurchForge is standardizing on Supabase for Postgres, Auth,
