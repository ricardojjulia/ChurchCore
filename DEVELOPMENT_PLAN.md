...
**MVP readiness: 69/100** (Council Review 18, 2026-09-24): up from 65/100, where it sat through Reviews 9–13. Service planning Stories 1–2 and the blocking E2E test net moved it.
...
Compared against Planning Center Online, Breeze ChMS and Tithe.ly. The ranking comes from Council Review 9 Agent 4 and has held through Review 18. Status was re-verified in code on 2026-09-25; see `docs/plans/2026-09-25-mvp-competitive-status-report.md`.

| # | Gap | Status (2026-09-25) | Definition of done | Estimate |
|---|---|---|---|---|
| 1 | **Service planning depth**: setlists, song library, volunteer-role matching | **~75% closed.** Story 1 (song library and setlist builder, PR #146) and Story 2 (role taxonomy, team roster, skill-ranked assignment, PR #147) are merged. | **Story 3:** rotation planner, i.e. fatigue- and history-aware volunteer suggestions (wires `burnout-calculator`). **Story 4:** rehearsal scheduling. **Story 5:** a service plan requires its event. Plus journey tests: build a plan, add songs, assign volunteers. | 2–3 weeks remaining |
...
**Working order:** gap 1 (finish Stories 3–5), then gap 3 (recurring giving, the largest competitive hole), then gap 2, then gap 4, then gap 5.
