  ...
  function handleDownloadExport() {
    startTransition(async () => {
      try {
        ...
        a.href = url;
        a.download = `churchcore-data-export-${new Date().toISOString().slice(0, 10)}.json`;
        a.click();
    ...
    <Stack gap="lg">
      ...
      <Paper withBorder p="lg" radius="md">
        ...
        <Text fz="xs" c="dimmed" mb="md">
          Download a copy of all personal information ChurchCore holds about you — profile, ministry assignments, consent logs, notification preferences, and giving history. No passwords or payment card data are included.
        </Text>
      ...
      <Paper withBorder p="lg" radius="md">
        ...
        <Stack gap="xs">
          ...
          <Text fz="xs" c="dimmed">
            Your giving records are held by your local church and governed by their privacy policy. ChurchCore never shares your personal or financial information with third parties without your consent.
          </Text>
          <Text fz="xs" c="dimmed">
      ...
      <Text fz="xs" c="dimmed" ta="center">
        ChurchCore is committed to your privacy. All data handling is governed by your church&rsquo;s privacy policy and applicable law.
      </Text>
    </Stack>
  );
}
