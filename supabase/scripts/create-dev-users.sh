...
DEFAULT_PASSWORD="${CHURCHFORGE_DEV_PASSWORD:-$(python3 - <<'PY'
import secrets
import string
...
CHURCHFORGE_DEV_PASSWORD=${DEFAULT_PASSWORD}
CHURCHFORGE_DEMO_ADMIN_EMAIL=sarah@churchforge.app
CHURCHFORGE_DEMO_MEMBER_EMAIL=david@graceharbor.church
EOF
