...
PY
    ...
    require_contains "/app/church-admin/settings" "Church setup"
    require_contains "/app/church-admin/accounts?status=pending" "Approval queue"
    require_contains "/app/church-admin/people?view=incomplete-profiles" "Readiness view"
    require_contains "/app/church-admin/people?view=unassigned-households&household=unassigned" "Readiness view"
    require_contains "/app/church-admin/events?view=needs-roster" "Readiness view"
    require_contains "/app/church-admin/children/dashboard?view=readiness" "Volunteers"
    require_contains "/app/church-admin/volunteers/schedules?view=unassigned" "Service Plans"
    ...
    require_contains "/app/communications?view=readiness" "Communications Hub"
    require_contains "/app/reports?range=90d" "Reports"
    require_contains "/app/church-admin/workflows?status=open" "Readiness view"
