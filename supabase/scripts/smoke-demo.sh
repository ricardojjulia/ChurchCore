...
PY
    ...
    require_contains "/app/church-admin/children/dashboard?view=readiness" "Readiness view"
    require_contains "/app/church-admin/giving?view=exceptions" "Readiness view"
