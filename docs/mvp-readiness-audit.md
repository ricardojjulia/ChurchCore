...
- **Empty/error states:** every admin module should explain whether it has no data, no backend, or insufficient permission. The shared readiness target-state pattern is started and should be expanded beyond settings, people, and giving/finance.
