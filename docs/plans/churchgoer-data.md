# ChurchCore - Churchgoer Data Management Plan

**Living Document** - Last Updated: April 12, 2026  
**Filename**: `docs/plans/churchgoer-data.md`  
**Version**: 1.1  
**Purpose**: This is the single source of truth for all churchgoer data handling in ChurchCore. It covers how churchgoer information is collected, maintained, searched, protected, and used throughout the platform, along with the complete design of the self-service Churchgoer Portal.
...
- Mobile-first
- Mantine-based, aligned with the ChurchCore application shell
...
This document defines how ChurchCore treats every churchgoer with dignity, care, and respect for their data.
