# ChurchCore — Security & Privacy Assessment
...
`emergency_contact_name` and `emergency_contact_phone` belong to individuals who have no account with ChurchCore, have not accepted any privacy policy, and do not know their data is stored. Under GDPR Article 13/14 and California CPRA, you have disclosure obligations to these third parties.
