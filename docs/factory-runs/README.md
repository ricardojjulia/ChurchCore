...
| 2026-09-18 | [Tenant provisioning, RLS CI gate, and Council Review 10](2026-09-18-tenant-provisioning-rls-gate-and-council-review-10.md) | Generic tenant provisioning tool, blocking RLS CI gate fix, full whole-app Council Review 10, and Documenter close-out | Pending (PR not yet opened) |
